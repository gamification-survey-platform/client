...
const TriviaPopup = ({ courseId, courses }) => {
  ...
  const showNextHint = () =>
    setCurrentHintIndex((prevIndex) => Math.min(prevIndex + 1, trivia?.hints.length - 1))
  ...
  return (
    <>
      ...
      <Modal
        ...
        title={
          <div style={{ fontWeight: 'bold', fontSize: '24px', color: '#3e79f7' }}>Trivia Time!</div>
        }
        visible={visible}
        ...
        {trivia ? (
                ...
                extra={
                  <>
                    ...
                    <Button
                      ...
                      disabled={currentHintIndex === trivia.hints.length - 1}
                    />
                  </>
                }
                headStyle={{ fontSize: '22px', color: '#3d405b' }}
          ...
          <p
            ...
            😅 Oh no! It seems like this course has no trivia! Please explore other courses for more
            trivia fun! 🎓🚀
          </p>
        )}
      </Modal>
